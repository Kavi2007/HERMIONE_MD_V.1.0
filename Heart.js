...
https://chat.whatsapp.com/Jllsl2OaQNoBjepxzuVsZM`
      ...
      case "info":
        ...
        let ifx = `🌟『𝕄𝕒𝕣𝕚𝕒-𝕄𝕕 』🌟
*🌟Description:* A WhatsApp Bot With Rich  features based on HermioneMD
*👤Creator:*  ROCKY EXE 
*🕸Version:* 1.0.0
*🎀supportgc:* https://wa.me/message/5D3E24IRBETEJ1
...
case 'google': {
Maria.sendMessage(from, { react: { text: "🔎", key: m.key }}) 
if (!q) return reply(`Example : ${prefix + command} ROCKY EXE`)
...
case 'truth':
  ...
  const txt = `╭─「 *Konichiwa* 」
│⋊ 𝕌𝕤𝕖𝕣: *${pushname}* 
│⋊ 𝕓𝕠𝕥 ℕ𝕒𝕞𝕖: HERMIONE-MD
│⋊ ℙ𝕣𝕖𝕗𝕚𝕩:  [ *${prefix}* ]
│⋊ 𝕆𝕨𝕟𝕖𝕣: ${prefix}owner
│⋊ 𝕋𝕠𝕥𝕒𝕝𝕔𝕞𝕕: ${mariafeature()}
│⋊ 𝕆𝕗𝕗𝕚𝕔𝕚𝕒𝕝 𝔾𝕣𝕠𝕦𝕡: https://wa.me/message/5D3E24IRBETEJ1
╰────────────┈平和
